...
<%
    ArrayList<Contact> allContact = (ArrayList<Contact>) session.getAttribute("allContact");
...
<table align="center" width="700" border="2">
    ...
    %>
    <tr>
        <td><%=contact.getClientName()%></td>
        <td><%=contact.getContactName()%></td>
        <td><%=contact.getContactName()%></td>
        <td><%=contact.getContactStart()%></td>
        <td><%=contact.getContactEnd()%></td>
        <td><%=contact.getStaffName()%></td>
    </tr>
    <% }%>
</table>
</body>
