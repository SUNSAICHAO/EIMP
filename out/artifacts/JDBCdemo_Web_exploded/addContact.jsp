...
<%
    String msg = (String) session.getAttribute("addContactMsg");
...
<form action="addContact" method="post">
    ...
    <label>合同名称</label><input type="text" name="contactName"><br>
    <label>合同内容</label><input type="text" name="contactContents"><br>
    <label>合同生效日期</label><input type="text" name="contactStart"><br>
    <label>合同有效期</label><input type="text" name="contactEnd"><br>
