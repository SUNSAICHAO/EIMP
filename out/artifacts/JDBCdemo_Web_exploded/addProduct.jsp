...
<%
    String msg = (String) session.getAttribute("addProductMsg");
...
<form action="addProduct" method="post">
    ...
    <h1>添加产品信息</h1>
    <label>产品名称</label><input type="text" name="productName"><br>
    <label>产品型号</label><input type="text" name="productModel"><br>
    <label>产品数量</label><input type="text" name="productNumber"><br>
    <label>产品价格</label><input type="text"name="productPrice"><br>
