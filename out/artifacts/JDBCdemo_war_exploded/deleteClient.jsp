...
<% String msg = (String) session.getAttribute("deleteClientMsg");
...
%>
<form action="deleteClient" method="post" style="text-align: center;">
    <% if (msg!=null)
        out.println("<h1>"+msg+"</h1>");%>
    <h1>删除客户信息</h1>
    <label>客户姓名</label><input type="text" name="clientName"><br><br>
